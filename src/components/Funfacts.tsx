...
export default function Funfacts() {
  return (
    <div className="my-[8rem] flex flex-col ">
      ...
      <div className="grid md:grid-cols-2 min-[1200px]:grid-cols-4 gap-5  items-center justify-center my-10">
        <div className="w-[294px] min-[1200px]:w-[250px] h-[184px]  border-2 rounded-xl  bg-[#333] border-[#444] flex flex-col justify-center gap-4 items-center text-white hover:-translate-y-2 transition-all duration-[600ms]">
